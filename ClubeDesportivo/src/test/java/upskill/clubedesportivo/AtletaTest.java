...
public class AtletaTest {
    ...
    public void testValidarAtividade() {
        Atleta instance = new AtletaPro(600, 300, "Carlos", 123456789, "Masculino", 32, 70, "corrida", "QueimaGordura");
    ...
    public void testValidarAtividadeInvalido() {
        Atleta instance = new AtletaPro(600, 300, "Carlos", 123456789, "Masculino", 32, 70, "patinagem", "QueimaGordura");
    ...
    public void testValidarObjetivo() {
        Atleta instance = new AtletaSemiPro(7, "Marta", 345678123, "Feminino", 27, 65, "ciclismo", "CapacidadeCardio");
        boolean expResult = true;
    ...
    public void testValidarObjetivoInvalido() {
        Atleta instance = new AtletaSemiPro(7, "Marta", 345678123, "Feminino", 27, 65, "futebol", "Força");
        boolean expResult = false;
        boolean result = instance.validarObjetivo();
        assertEquals(expResult, result);
    }
    ...
    public void testObterIT() {
        ...
        Atleta instance = new AtletaAmador(22, "Jorge", 543876098, "Masculino", 40, 55, "caminhada", "QueimaGordura");
    ...
    public void testCalcularFCMCiclismoMasculino() {
        System.out.println("calcularFCM");
        Atleta instance = new AtletaSemiPro(7, "Miguel", 345373123, "Masculino", 40, 65, "ciclismo", "CapacidadeCardio");
    ...
    public void testCalcularFCMNatacao() {
        System.out.println("calcularFCM");
        Atleta instance = new AtletaAmador(22, "Jorge", 543876098, "Masculino", 35, 55, "natação", "QueimaGordura");
